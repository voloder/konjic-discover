...
import 'package:discover/ui/about_konjic.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [const AboutKonjic(), SekcijeView(sekcije: sekcije)],
        ),
      ),
    );
  }
...
class _SekcijeViewState extends State<SekcijeView> {
  ...
  // openFunction(Kategorija kategorija) {
  //   print("USPJESNO POKRENUTO: $kategorija");
  //   Navigator.push(
  //       context,
  //       PageRouteBuilder(
  //         pageBuilder: (context, animation, secondaryAnimation) => LokacijePage(
          ...
          return Column(
            ...
            children: [
              Padding(
                ...
                child: Center(
                  child: Text(sekcija.getLocalizedNaziv(jezik),
              ...
              SizedBox(
                ...
                child: PageView.builder(
                  ...
                  // itemCount: index == 0? sekcija.kategorije.length-1 : sekcija.kategorije.length,
            ...
            Center(
              child: Text(
                ...
                style: const TextStyle(
                    ...
                    fontWeight: FontWeight.bold),
                softWrap: true,
                kategorija.getLocalizedNaziv(jezik),
              ),
            )
          ]),
        ),
