...
class PrivacyPolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        Text('Privacy Policy for Konjic Discover', style: TextStyle(fontWeight: FontWeight.bold)),
        Text('Konjic Discover ("we," "our," or "us") respects your privacy and is committed to protecting any information that you may provide while using our mobile application. This Privacy Policy outlines the types of personal information that is received and collected by Konjic Discover and how it is used. This policy is available on our app’s store listing page in Play Console and within the app itself.', style: TextStyle(fontSize: 12, fontFamily: "Montserrat-Light", fontWeight: FontWeight.bold)),
        ...
        Text('While we strive to use commercially acceptable means to protect your information, we cannot guarantee its absolute security. The security of your personal information is important to us.', style: TextStyle(fontSize: 12, fontFamily: "Montserrat-Light", fontWeight: FontWeight.bold)),
        Text('Children\'s Privacy', style: TextStyle(fontWeight: FontWeight.bold)),
        Text('Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from children under 13. If we discover that a child under 13 has provided us with personal information, we will delete such information immediately. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact us so that we will be able to take necessary actions.', style: TextStyle(fontSize: 12, fontFamily: "Montserrat-Light", fontWeight: FontWeight.bold)),
        ...
        Text('By using Konjic Discover, you signify your acceptance of this Privacy Policy. If you do not agree to this policy, please do not use our application.', style: TextStyle(fontSize: 12, fontFamily: "Montserrat-Light", fontWeight: FontWeight.bold)),
      ],);
  }
}
